            ...
            <!-- <div class="row"> -->
                <form method="POST" action="{{ route('daftarEvent') }}">
                    ...
                    <div class="container">
                        ...
                        <button style="float:right; width:150px; background-color:#FD7EC2; color:#FFF2F9;" class="btn btn-pink" type="submit">Ikut Kolaborasi</button>
                        <br><br>
        ...
        <form action="{{route('newComment_event')}}" method="post">
            ...
            <div class="row comment-box-main p-3 rounded-bottom">
                <div class="col-md-10 col-sm-10 col-10 pr-0 comment-box">
                    ...
                    <input type="text" name="events_comments" class="form-control" placeholder="Masukkan komentar...." autocomplete="off" />
                </div>
