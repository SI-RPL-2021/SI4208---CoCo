    ...
    <div class="container-2" style="background-color: #FFFFFF;">
        ...
        <div class="container-3" style="background-color: #FFFFFF;">
            <div class="row">
                ...
                <div class="col-md-10">
                    <font style=font-size:large;font-weight:bolder;>Kampanye Mental Health</font>
                    ...
                    <br><br>
                    <font style=float:right;font-size:small;font-weight:bolder;color:#A9A9A9>2/15 Orang dalam Tim</font>
                    <br>
                    <p class="left">Bipolar Pada Milenial dan Gen Z.
                        Mari membuat kampanye sekaligus seminar di masa Pandemi COVID-19 ini secara online khususnya untuk generasi milineal dan gen Z tentang bagaimana sih cara kita mengatasi mental health kita di masa karantina ini.
                        <br>
                        Let’s be collaborative and creative!
                        <br>
                        Don’t be shy to drop your questions!
                    <p>
                        <p1 class="left" style=color:#FD7EC2>Tanggal pelaksanaan : 10 Maret 2021 - 20 Maret 2021<p1>
                                <br> <br>
                                <font style=font-weight:bolder;color:#000000>Pertanyaan</font>
                </div>
                <div class="media">
